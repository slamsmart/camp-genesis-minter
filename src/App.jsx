        ...
        {activePage === "about" && (
          <div className="w-full max-w-3xl bg-white/80 text-black backdrop-blur p-6 rounded-xl shadow-md">
            ...
            <p className="text-sm leading-relaxed">
              <strong>Camp Genesis Minter</strong> is a lightweight NFT minting dApp built by <strong>slamsmart</strong> for the <strong>Wizz x Camp Bounty Builder</strong> competition.<br /><br />
